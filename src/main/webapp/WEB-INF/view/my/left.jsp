...
<ul  style="text-align:center;list-style-type:none;background-color: white;" class="sidebar navbar-nav" >
			...
			<li><a class="my-btn btn-outline-danger" style="text-decoration:none;"  href="javascript:void(0)" data="article/selectArticleList">
					<span>查看文章</span>
			</a></li>
		
			<li><a class="my-btn btn-outline-danger" style="text-decoration:none;"  href="javascript:void(0)" data="article/toAdd">
					 <span>发布文章</span>
			</a></li>

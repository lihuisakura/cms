...
<ul  style="text-align:center;list-style-type:none;background-color: white;" class="sidebar navbar-nav" >
			...
			<li style="margin-top: 3px"><a class="my-btn btn-outline-danger" style="text-decoration:none;"  href="javascript:void(0)" data="article/selects">
					<i class="fas fa-fw fa-folder"></i> <span>文章管理</span>
			</a></li>
		
			<li style="margin-top: 3px"><a class="my-btn btn-outline-danger"  style="text-decoration:none;" href="javascript:void(0)" data="user/selects">
